# Presentation plan 5 minutes technical 2 minutes pitch 3 minutes questions
...
| 4:15-5:00 | Engineers | Cost, missed targets and remaining limits. |
| 5:00-7:00 | Stakeholder | Business problem, cloud value, cost and market gap. Do not show architecture diagrams. |

Prepare backup slides for the six NFRs, ADR alternatives, raw-data layout, scaling timeline and cost assumptions. Record a backup demo video because the deployed endpoint or network may fail on the day.
